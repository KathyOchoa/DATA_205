...
comCols <- c("X.1", "X", "age", "age_neonate", "amonth", "aweekend", "died", 
             "discwt", 
              "dispuniform", "dqtr", "drg", "drgver", "drg_nopoa", "dxver",
              "elective", "female", "hcup_ed", "hcup_division", "hosp_nis",
             ...
             "prver", "race", "totchg", "tran_in", "tran_out", "year",
              "zipinc_qrtl", "flap")
comcols2 <- c("X.1", "X", "age", "age_neonate", "amonth", "aweekend", "died", 
              "discwt", 
              "dispuniform", "dqtr", "drg", "drgver", "drg_nopoa",
              "elective", "female", "hcup_ed", "hcup_division", "hosp_nis",
              "i10_dx1", "i10_dx2", "i10_dx3", "i10_dx4", "i10_dx5", 
              "i10_dx6","i10_dx7", "i10_dx8", "i10_dx9", "i10_dx10", 
              "i10_dx11","i10_dx12","i10_dx13", "i10_dx14", "i10_dx15", 
              ...
              "zipinc_qrtl", "flap", "i10_dx31", "i10_dx32", "i10_dx33", "i10_dx34", "i10_dx35", 
